...
namespace SkillCheck_BE_BusinessServices_Audits.Service.ImplementaionUpdated
{
    ...
    {
        public Task<IEnumerable<AuditCheckDto>> GetAllModuleByTechnologies(long technologyId)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<AuditCheckDto>> GetAllUnitByModuleName(string moduleName)
        {
            throw new NotImplementedException();
        }
    }
